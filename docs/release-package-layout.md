...
- NatsX-1.0.3-windows-amd64-assets.md
- NatsX-1.0.3-windows-amd64-github-release.md
```
...
```text
release/
- NatsX-1.0.3-windows-amd64-setup.exe
```

## Notes

- The script reads version metadata from `wails.json`
- The recommended GitHub tag format is `v1.0.3`
